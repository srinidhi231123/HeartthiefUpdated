...
URL = "jiraiyafilterbot.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "jiraiyafilterbot.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "jiraiyafilterbot.koyeb.app/".format(FQDN)
else:
    URL = "jiraiyafilterbot.koyeb.app/".format(FQDN)
